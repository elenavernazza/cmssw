...
jetPuppiTable = simplePATJetFlatTableProducer.clone(
    ...
    variables = cms.PSet(P4Vars,
        ...
        # new b-hive model
        btagMyUParTditauh =  Var("?bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:tauhtauh')>0? bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:tauhtauh'):-1",float,precision=12,doc="Aleternative UnifiedParT ditauh raw score"),
        btagMyUParTditaumu =  Var("?bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:tauhtaumu')>0? bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:tauhtaumu'):-1",float,precision=12,doc="Aleternative UnifiedParT ditaumu raw score"),
        btagMyUParTditaue =  Var("?bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:tauhtaue')>0? bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:tauhtaue'):-1",float,precision=12,doc="Aleternative UnifiedParT ditaue raw score"),
        btagMyUParTprobb =  Var("?bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:probb')>0? bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:probb'):-1",float,precision=12,doc="Aleternative UnifiedParT b-tag raw score"),
        btagMyUParTprobc =  Var("?bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:probc')>0? bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:probc'):-1",float,precision=12,doc="Aleternative UnifiedParT c-tag raw score"),
        btagMyUParTprobother =  Var("?bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:probother')>0? bDiscriminator('pfMyUnifiedParticleTransformerAK4DiscriminatorsJetTags:probother'):-1",float,precision=12,doc="Aleternative UnifiedParT light quarks raw score"),
