...
# with command line options: step2 -s DIGI:pdigi_valid,L1TrackTrigger,L1,L1P2GT,DIGI2RAW,HLT:@relvalRun4,NANO:@HLT --conditions auto:phase2_realistic_T33 --datatier GEN-SIM-DIGI-RAW,NANOAODSIM --eventcontent FEVTDEBUGHLT,NANOAODSIM --geometry ExtendedRun4D110 --era Phase2C17I13M9 --filein file:step1.root --fileout file:step2.root -n 10
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/eos/user/e/evernazz/www/NGT/NanoAOD/step1.root'),
