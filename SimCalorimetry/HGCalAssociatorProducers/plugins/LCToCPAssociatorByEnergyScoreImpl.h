...
using HGCalLCToCPAssociatorByEnergyScoreImpl	= LCToCPAssociatorByEnergyScoreImplT<HGCRecHit, reco::CaloClusterCollection>;
using BarrelLCToCPAssociatorByEnergyScoreImpl	= LCToCPAssociatorByEnergyScoreImplT<reco::PFRecHit, reco::CaloClusterCollection>;
using HGCalPCToCPAssociatorByEnergyScoreImpl	= LCToCPAssociatorByEnergyScoreImplT<HGCRecHit, reco::CaloClusterCollection>;
using BarrelPCToCPAssociatorByEnergyScoreImpl	= LCToCPAssociatorByEnergyScoreImplT<reco::PFRecHit, reco::CaloClusterCollection>;
