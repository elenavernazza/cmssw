...
using HGCalLCToCPAssociatorByEnergyScoreProducer = LCToCPAssociatorByEnergyScoreProducerT<HGCRecHit, reco::CaloClusterCollection>;
DEFINE_FWK_MODULE(HGCalLCToCPAssociatorByEnergyScoreProducer);
using BarrelLCToCPAssociatorByEnergyScoreProducer = LCToCPAssociatorByEnergyScoreProducerT<reco::PFRecHit, reco::CaloClusterCollection>;
DEFINE_FWK_MODULE(BarrelLCToCPAssociatorByEnergyScoreProducer);
using HGCalPCToCPAssociatorByEnergyScoreProducer = LCToCPAssociatorByEnergyScoreProducerT<HGCRecHit, reco::PFClusterCollection>;
DEFINE_FWK_MODULE(HGCalPCToCPAssociatorByEnergyScoreProducer);
using BarrelPCToCPAssociatorByEnergyScoreProducer = LCToCPAssociatorByEnergyScoreProducerT<reco::PFRecHit, reco::PFClusterCollection>;
