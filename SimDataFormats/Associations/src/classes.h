...
namespace {
  struct dictionary {
    ...
    edm::Wrapper<edm::helpers::KeyVal<edm::RefProd<std::vector<SimCluster>>, edm::RefProd<std::vector<reco::PFCluster>>>> w_keyVal1;
    edm::Wrapper<edm::helpers::KeyVal<edm::RefProd<std::vector<reco::PFCluster>>, edm::RefProd<std::vector<SimCluster>>>> w_keyVal2;

    edm::Wrapper<edm::AssociationMap<edm::OneToManyWithQualityGeneric<
