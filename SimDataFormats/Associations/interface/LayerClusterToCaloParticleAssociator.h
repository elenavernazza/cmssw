...
namespace ticl {
  ...
  public:
    explicit LayerClusterToCaloParticleAssociatorT(std::unique_ptr<ticl::LayerClusterToCaloParticleAssociatorBaseImplT<CLUSTER>> impl)
    ...
    LayerClusterToCaloParticleAssociatorT(const LayerClusterToCaloParticleAssociatorT<CLUSTER> &) = delete;  // stop default
