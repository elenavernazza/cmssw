#ifndef Validation_HGCalValidation_PFVHistoProducerAlgo_h
#define Validation_HGCalValidation_PFVHistoProducerAlgo_h
...
struct PFVHistoProducerAlgoHistograms {
  //Info
  ...
  std::unordered_map<int, dqm::reco::MonitorElement*> h_score_recocl2caloparticle_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_score_caloparticle2recocl_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_energy_vs_score_caloparticle2recocl_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_energy_vs_score_recocl2caloparticle_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_sharedenergy_caloparticle2recocl_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_sharedenergy_caloparticle2recocl_vs_eta_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_sharedenergy_caloparticle2recocl_vs_phi_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_sharedenergy_recocl2caloparticle_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_sharedenergy_recocl2caloparticle_vs_eta_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_sharedenergy_recocl2caloparticle_vs_phi_perlayer;
  ...
  std::unordered_map<int, dqm::reco::MonitorElement*> h_num_recocl_eta_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_numMerge_recocl_eta_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_denom_recocl_eta_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_num_recocl_phi_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_numMerge_recocl_phi_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_denom_recocl_phi_perlayer;
  ...
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_denom_recocl_in_simcl_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_denom_recocl_in_simcl_phi_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_score_recocl2simcl_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_sharedenergy_recocl2simcl_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_energy_vs_score_recocl2simcl_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_num_recocl_in_simcl_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_num_recocl_in_simcl_phi_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_numMerge_recocl_in_simcl_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_numMerge_recocl_in_simcl_phi_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_sharedenergy_recocl2simcl_vs_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_sharedenergy_recocl2simcl_vs_phi_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_denom_simcl_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_denom_simcl_phi_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_score_simcl2recocl_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_sharedenergy_simcl2recocl_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_energy_vs_score_simcl2recocl_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_num_simcl_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_num_simcl_phi_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_numDup_simcl_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_numDup_simcl_phi_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_sharedenergy_simcl2recocl_vs_eta_perlayer;
  std::vector<std::unordered_map<int, dqm::reco::MonitorElement*>> h_sharedenergy_simcl2recocl_vs_phi_perlayer;
};

using Density = hgcal_clustering::Density;

class PFVHistoProducerAlgo {
public:
  ...
  PFVHistoProducerAlgo(const edm::ParameterSet& pset);
  ~PFVHistoProducerAlgo();

  using Histograms = PFVHistoProducerAlgoHistograms;
  ...
  void bookClusterHistos_RCtoCP_association(DQMStore::IBooker& ibook, Histograms& histograms, unsigned int layers);
  ...
  void recoClusters_to_CaloParticles(const Histograms& histograms,
  ...
  void fill_RecoClusters_to_SimClusters(const Histograms& histograms,
										const int count,
										edm::Handle<reco::PFClusterCollection> clusterHandle,
										const reco::PFClusterCollection& clusters,
										...
										std::unordered_map<DetId, const unsigned int> const&,
										unsigned int layers,
										const ticl::RecoToSimCollectionWithSimClustersT<reco::PFClusterCollection>& recSimColl,
										const ticl::SimToRecoCollectionWithSimClustersT<reco::PFClusterCollection>& simRecColl,
										MultiVectorManager<HGCRecHit> const& hits) const;
  ...
  void fill_simClusterAssociation_histos(const Histograms& histograms,
                                         ...
                                         const ticl::SimToRecoCollectionWithSimClustersT<reco::PFClusterCollection>& simRecColl,
                                         MultiVectorManager<HGCRecHit> const& hits) const;
  void fill_cluster_histos(const Histograms& histograms, const int count, const reco::PFCluster& cluster) const;
  double distance2(const double x1, const double y1, const double x2, const double y2) const;
  double distance(const double x1, const double y1, const double x2, const double y2) const;

  void setRecHitTools(std::shared_ptr<hgcal::RecHitTools> recHitTools);

  DetId findmaxhit(const reco::PFCluster& cluster,
                   std::unordered_map<DetId, const unsigned int> const&,
                   MultiVectorManager<HGCRecHit> const& hits) const;
