"""
This script runs the SimpleValitation.
...
To run:
cmsRun SimpleBinnedValidation_cfg.py inputFiles=file:/path/to/step2.root
"""
...
process = cms.Process("SimpleBinnedValidation",Phase2C17I13M9)
...
process.SimpleBinnedValidation = cms.EDAnalyzer("SimpleBinnedValidation",
...
process.simDoubletProduction = cms.Path(
    ...
    process.SimpleBinnedValidation 
)
